...
export const constantRoutes = [
    ...
    children: [
      {
        ...
        name: 'Info',
        meta: { title: '店铺信息', icon: 'documentation', noCache: true }
      }
    ]
  },
...

  {
    ...
    meta: { title: '人事管理', icon: 'peoples', affix: true },
    children: [
      {
        path: 'management',
        component: () => import('@/views/management/index'),
        name: 'Employee',
        meta: { title: '员工管理', icon: 'people', noCache: true }
      },
      {
        path: 'add',
    ...
    children: [
      {
        ...
        name: 'Profile',
        meta: { title: '库存管理', icon: 'example', noCache: true }
      }
    ]
  },
  {
